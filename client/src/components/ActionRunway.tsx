...
import { ArrowUpRight, CalendarDays, Check, CheckCircle2, ChevronDown, ChevronRight, CircleAlert, Clock3, ListChecks, Plus, Sparkles, UsersRound } from "lucide-react";
...
export default function ActionRunway({ onNavigate }: { onNavigate: (screen: ScreenTarget) => void }) {
  ...
  const openActions = useMemo(() => initialActions.filter((item) => !completed.includes(item.id)), [completed]);
