// Shared TLS config for one-off migration scripts, so they use the same
// pinned-CA verification as the running server (server/db.ts) instead of
// rejectUnauthorized: false. Import this into every new migration script.
